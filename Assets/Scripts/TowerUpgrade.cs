...
public class TowerUpgrade //Still need to define Hallowed 
{
	...
	public TowerUpgrade(int price, int specialDamage, int damage, float debuffDuration, float procChance, float tickTime){
		this.Damage = damage;
		this.DebuffDuration = debuffDuration;
		this.ProcChance = procChance;
